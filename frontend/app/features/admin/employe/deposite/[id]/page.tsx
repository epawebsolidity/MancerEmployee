...
import { useDeposite } from "@/app/hooks/useDeposite";
const EmployeeDepositePage = ({ params }: { params: { id: string } }) => {
  const {
    employee,
    salary,
    setSalary,
...
export default EmployeeDepositePage;
